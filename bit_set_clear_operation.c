/* This file checks wheather the bit at nth position is set or 
not. It also clears the bit at the nth position. The number is 
displayed in both Hexadecimal as well as
 Binary format*/
